      ...
      >
        ...
        {isPdf && pdfDoc && (
          <div 
            ...
            className={`flex items-center justify-between gap-2 flex-shrink-0 transition-all duration-500 ${
              isFullscreen
                ? `absolute bottom-6 left-1/2 -translate-x-1/2 z-30 bg-black/80 backdrop-blur-md rounded-2xl px-4 py-2.5 shadow-2xl border border-white/10 max-w-[95vw] ${
