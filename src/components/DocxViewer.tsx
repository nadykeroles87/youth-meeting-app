  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="flex-1 min-h-0 relative bg-stone-50 overflow-y-auto scroll-smooth"
      >
        <div className="max-w-4xl mx-auto my-4 sm:my-8 bg-white shadow-sm border border-stone-200 min-h-[1000px] p-6 sm:p-12 docx-content text-right" style={{ direction: "rtl" }}>
          <div 
